...
These skills are:
 ...
 - dgx-spark-trainer -> "hf-llm-trainer-dgx-spark/skills/dgx-spark-trainer/SKILL.md"
...
dgx-spark-trainer: `Train and fine-tune language models locally on NVIDIA DGX Spark with Blackwell architecture. Supports Unsloth (2x faster training) and LLaMA Factory (flexible YAML configs) frameworks. Covers SFT, LoRA, and QLoRA training methods with 128GB unified memory for models up to 70B parameters. Should be invoked for tasks involving local GPU training on DGX Spark, desktop AI workstation training, or when users mention training without cloud infrastructure.`
</available_skills>
